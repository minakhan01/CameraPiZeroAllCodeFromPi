...
from aiy.vision.models import person_recognition
...
def main():
    ...
    with PiCamera() as camera:
        ...
        with CameraInference(person_recognition.model()) as inference:
            for i, result in enumerate(inference.run()):
                if i == args.num_frames:
                    break
                classes = person_recognition.get_classes(result)
